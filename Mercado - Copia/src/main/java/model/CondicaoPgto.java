...
public class CondicaoPgto {
    ...
    public String toString() {
        return "CondicaoPgto{" + "id=" + this.getId() + ", descricaoCondicao=" + this.getDescricaoCondicao() + ", numeroParcelas=" + this.getNumeroParcelas() + ", diasPrimeiraParcela=" + this.getDiasPrimeiraParcela() + ", diaEntreParcela=" + this.getDiaEntreParcela()+ ", status=" + this.getStatus() + '}';
    }
